		...
		<div class='w3-container'>
           <!-- Start large-list -->
            ...
            <section class='large-list'>        <br/>
                    ...
                    <form method='post' action='".controlRoomController::add_category()."'>                            
                                             <br/>
										<br/>
										<br/>                                              
                                                <!--	Select Countries -->
                                                ...
                                                <input class ='w3-text-red w3-input' type='text' name='name' placeholder='Enter Category Name' required>
                                                <br/>
                                           
                                        <br/>
										<br/>
										<br/>
										<input class='w3-btn w3-blue' type='submit' name='add-category-submit' style='float:right;'value='Add Category'>
                                        <br/>
										<br/> 
                                        <br/> 
                                        <br/>
