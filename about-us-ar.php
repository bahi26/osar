                            ...
                            <div class="navbar top-navbar" role="navigation">
                                ...
                                <nav class="collapse collapsing navbar-collapse">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li><a href="about-us-en.php">الإنجليزية</a></li>
                                    </ul><!--End navbar-nav-->
                        ...
                        <div class="row">
                            <div class="col-md-8">
                               <!--End box-wrap-->
                                ...
                                <div class="map-wrap">
                                    <h3>- من نحن :</h3>
                                    نحن الداعمين لأهداف الأسر المنتجة لنرقى بخدماتهم ومنتجاتهم. بعد تفكير ودراسة .. <br>
                                    أنشأنا أول موقع إلكتروني بالوطن العربي ليكون البازار المميز لعرض منتجات الأسر المنتجة بكافة أنواعها دون تحديد ..<br>
                                    بدءاً من: (المأكولات المنزلية – الملبوسات اليدوية – الإكسسوارات المنزلية - ... والمزيد مما تتحفنا به أسرنا العربية الرائعة). من اليوم أزحنا عنك هم التفكير في كيفية تكوين رأس المال لتتمكن من بدء مشروعك .. فمن خلال البازار الخاص بنا ستتمكن من عرض كافة منتجاتك من خلال خطوات سهلة وبسيطة. فريق عمل من المحترفين سيكون دائماً بجانبك لتضمن أنك تحصل على الخدمات والدعم الذي تستحقه. نؤمن بأن للفرد دور هام في تقدم المجتمع ورفعته, ولن تتقدم مجتمعاتنا أبداً إلا بقوة أفرادها .. مما دفعنا لبناء أول منصة إلكترونية لبيع وتسويق منتجات الأسر المنتجة بالوطن العربي بأكمله .. فنحن لم نقتصر على دول معينة, بل وفرنا خدمات موقعنا للجميع. 
                                    <h3>- رؤيتنا :</h3> رفعة شأن الأسر المنتجة ودعمها لنحقق تقدم الوطن العربي بأكمله. توفير متاجر مجانية إلكترونية للأسر المنتجة لعرض منتجاتهم بها دون الحاجة لوجود رأس مال كبير. 
                                    <h3>- رسالتنا :</h3> تعزيز دور الأسر المنتجة بالمجتمع .. والتركيز على دعمهم وتوفير كافة التسهيلات اللازمة لهم لتطوير أعمالهم وخبراتهم. 
                                    <h3>- أهدافنا :</h3> الوصول بالأسر المنتجة ومنتجاتهم للعالمية .. لنكون أوائل من دعموا وقدموا الخدمات اللازمة لتكون الأسر المنتجة عماد المجتمع الإستثماري. 
                                    <h3>- مميزاتنا :</h3>
                                    <p>
                                    1- دعم الأسر المنتجة في الوطن العربي بأكمله.<br> 
                                    2- منصة إلكترونية سهلة الإستخدام باللغة العربية. <br>
                                    3- لوحة تحكم بسيطة وواضحة للمتجر لإمكانية إضافة
                                    المنتجات ومراجعة الطلبات. <br>
                                    4- التسويق لمنتجات الأسر المنتجة عبر وسائل التواصل الإجتماعي الكبرى. <br>
                                    5- إنشاء متاجر إلكترونية مجانية للأسر المنتجة لعرض منتجاتهم. <br>
                                    6- دعم الأسر المنتجة من خلال فريق عمل محترف ومتواجد.<br>
                                    7- خصومات وهدايا للأسر المنتجة للمزيد من التحفيز. <br>
                                    8- تقديم دورات في كيفية العرض والبيع ودورات أخرى تساعد الأسر على ممارسة أعمالهم بإحترافية. <br>
                                    9- توفير دراسات الجدوى اللازمة لمشاريع الأسر المنتجة بمختلف تخصصاتها. <br>
                                    10- تفعيل خدمات توصيل المنتجات لكل الدول بالتعاون مع كبرى شركات الشحن العالمية.
                                    </p>
