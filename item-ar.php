...
$product =  Database::selectProduct($product_id);
$family=  Database::selectpersonInfo($product->getFamilyId());
                                ...
                                <nav class="collapse collapsing navbar-collapse">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li><a href="https://www.tawseelo.com/sign-up-rider?ref=10" target="_blank">شركة التوصيل</a></li>
                                                                                ...
                                                                                <li><a href="item.php?product=<?php echo $product_id;?>">الإنجليزية</a></li>
                                    </ul><!--End navbar-nav-->
                        ...
                        <div class="header-top">
                                <div class="main-drop full-mega">
                                    <div class="col-md-4">
                                        <h3>تابع معنا</h3>
                                        <a href="faq-ar.php">أسئلة شائعة</a>
                                        <a href="blogs-ar.php">مجتمع المنصة</a>
                                    </div><!--End col-md-3-->
                                    <div class="col-md-4">
                                        <h3>الشروط و الخصوصية</h3>
                                        <a href="terms-ar.php">الشروط والأحكام</a>
                                        <a href="privacy-ar.php">الخصوصية</a>
                                    </div><!--End col-md-3-->
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="gallery-slider">
                                <div class="gallery-image">
                                    <img src="products/images/<?php echo $product->getPhoto();?>" alt="" />
                                </div>
