        ...
        if(isset($_SESSION['id'])){
            ...
            if(in_array($file_ext,$allowed)){
                if($file_error==0)
                {
                    ...
                    {
                        header("Location: profile-ar.php?upload=size");
                        exit();
                    }
                    else
                    {
                        ...
                        if($lang==2)
                            ...
                            header("Location: profile-ar.php?upload=success&id=".$Country_id);
                        exit();
                    }
                }
                else
                {
                    header("Location: profile-ar.php?upload=uploading");
                    exit();
                }
            ...
            {
                header("Location: profile-ar.php?upload=type");
                exit();
            }
        }
        else
        {
            header("Location: login-register-ar.php?upload=logged");
            exit();
        }
                            ...
                            <div class="navbar top-navbar" role="navigation">
                                ...
                                <nav class="collapse collapsing navbar-collapse">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li><a href="profile.php">الإنجليزية</a></li>
                                    </ul><!--End navbar-nav-->
                        ...
                        <div class="row">
                            <div class="col-sm-9">
                                ...
                                <div class="profile-content">
                                    <form method="post" action="profile-ar.php" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                <label for="awner-name">الإسم</label>
                                                <input id="awner-name" class="form-control" type="text" placeholder="ادخل الاسم الخاص بك" value="<?php echo $data[1]['name'] ?>">
                                            </div><!--End col-md-6-->
                                            <div class="col-md-6 form-group">
                                       ...
                                       <div class="col-md-6 form-group">
                                        ...
                                        <button name="edit-family-submit" type="submit" class="custom-btn">تغيير البيانات</button>
                                    </form>
