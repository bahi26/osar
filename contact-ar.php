                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-8">
                                        ...
                                        <div class="form-group col-md-4">
                                            <input class="form-control" type="text" placeholder="البريد الإلكترونى">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <input class="form-control" type="text" placeholder="الموضوع">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <textarea class="form-control" type="text" placeholder="الرسالة" rows="6"></textarea>
                                        </div>
