                            ...
                            <div class="navbar top-navbar" role="navigation">
                                ...
                                <nav class="collapse collapsing navbar-collapse">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li><a href="home.php?id=<?php echo $country_id; ?>">الإنجليزية</a></li>
                                    </ul><!--End navbar-nav-->
                                </nav><!--End navbar-collapse-->
                            </div><!--End top-navbar-->                         

                            <a class="head-wish" href="favourite-ar.php?id=<?php echo $country_id ?>">
    ...
    ?>
                                    <div class="product-item">
                                        <div class="img-container">
                                            <a href="item-ar.php?product=<?php echo $product->getId();?>" class="product-img">
...
?>
                                        ...
                                        <div class="timer-count">
                                            <a href="family-products-ar.php?id=<?php echo $family->getId(); ?>&country=<?php echo $_GET["id"]; ?>">
                                                عرض منتجات <?php echo $family->getName();?>
                                            </a><!--End product-name-->
                                        </div><!--End timer-count-->                
