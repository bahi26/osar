...
//check if there's invalid data
        if ((!preg_match("/^[a-zA-Z]*$/", $first_name) & !empty($first_name)) ||
            ...
            header("Location: profile-user.php?profile=invalid&id=" . $Country_id);
            exit();
        } else {
            if (!Database::check_id($_SESSION['id'])) {
                header("Location: profile-user.php?profile=unknown");
                exit();
            } else {
        ...
        if (in_array($file_ext, $allowed)) {
            if ($file_error == 0) {
                if ($file_size > 50000000) {
                    header("Location: profile-user.php?upload=size");
                    exit();
                } else {
                ...
                header("Location: profile-user.php?upload=uploading");
                exit();
            }
        } else {
            header("Location: profile-user.php?upload=type");
            exit();
        }
    } else {
                            ...
                            <div class="navbar top-navbar" role="navigation">
                                ...
                                <nav class="collapse collapsing navbar-collapse">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li><a href="profile-user-ar.php">Arabic</a></li>
                                    </ul><!--End navbar-nav-->
                        ...
                        <div class="row">
                            <div class="col-sm-9">
                                ...
                                <div class="profile-content">
                                    <form method="post" action="profile-user.php" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input id="awner-name" class="form-control" type="text" placeholder="enter your first name" name="first_name" value="<?php echo $data[1]['first_name'] ?>">
                                            </div><!--End col-md-6-->
                                            <div class="col-md-6 form-group">
                                                <label for="awner-name">My Last Name</label>
                                                <input id="awner-name" class="form-control" type="text" placeholder="enter your last name" name="last_name" value="<?php echo $data[1]['last_name'] ?>">
                                            </div><!--End col-md-6-->
                                            <div class="col-md-6 form-group">
                                        ...
                                        <button name="edit-user-submit" type="submit" class="custom-btn">Edit Information</button>
                                    </form>
